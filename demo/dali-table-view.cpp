...
struct DemoRelativeToConstraint
{
  /**
   * @brief Constructor.
   */
  DemoRelativeToConstraint( float scale )
  : mScale( scale, scale, scale ) { }

  /**
   * @brief Constructor.
   */
  DemoRelativeToConstraint( const Vector3& scale )
  : mScale( scale ) { }
...
void DaliTableView::Initialize( Application& application )
{
  ...
  Constraint scrollViewConstraint = Constraint::New< Dali::Vector3 >( Dali::Actor::Property::SIZE, DemoRelativeToConstraint( SCROLLVIEW_RELATIVE_SIZE ) );
