...
void DaliTableView::Initialize( Application& application )
{
  ...
  logo.SetResizePolicy( USE_NATURAL_SIZE );
  ...
  backgroundColourActor.SetRelayoutSizeFactor( Vector3( 1.0f, 1.5f, 1.0f ) );
...
void DaliTableView::OnLogoTapped( Dali::Actor actor, const Dali::TapGesture& tap )
{
  if ( !mVersionPopupShown )
  {
    if ( !mVersionPopup )
    {
      ...
      mVersionPopup.SetRelayoutSizeFactor( Vector3( 0.75f, 1.0f, 1.0f ) );
