...
public:
  ...
  /**
   * Constructor
   * @param[in] outputFileName of the image to generate blur
   * @param[in] blurLevel The level of blurring to apply ( 1-6 )
   * @param[in] framebufferSize The size of the first framebuffer
   * @param[in] outputSize The size of the last framebuffer
   */
  SuperBlurGenerator( const Dali::BitmapLoader& inputImage, const std::string& outputFolder, const std::string& outputFileName, int blurLevel, Vector2 framebufferSize, Vector2 outputSize );
