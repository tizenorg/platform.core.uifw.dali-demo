...
public:
  ...
  void Create( Application& application )
  {
    ...
    Actor parent = ImageActor::New(ResourceImage::New(DALI_IMAGE_DIR "gallery-large-2.jpg"));
    ...
    ////not working
    ////child.SetRelayoutEnabled(false);
    //child.SetSizeModeFactor(Vector3(.5f,.5f,.5f));
    ...
    //child.SetSize(100,400);
    //child.SetSize(Vector2(100,400));
    //child.SetResizePolicy(USE_ASSIGNED_SIZE, ALL_DIMENSIONS);
    //child.SetResizePolicy(USE_ASSIGNED_SIZE, WIDTH);
    ...
    //child.SetResizePolicy(FIXED, ALL_DIMENSIONS);
    //child.SetResizePolicy(USE_NATURAL_SIZE, ALL_DIMENSIONS);
    ...
    //child.SetResizePolicy(USE_NATURAL_SIZE, WIDTH);
