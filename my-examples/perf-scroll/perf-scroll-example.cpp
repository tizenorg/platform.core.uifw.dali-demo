  ...
  void ScrollAnimation()
  {
    ...
    for( size_t i(0); i<actorCount; ++i )
    {
      if( gUseImageView )
      {
        ...
        mScroll.AnimateBy( Property( mImageView[i], Actor::Property::POSITION), Vector3( -12.0f*stageSize.x,0.0f, 0.0f));
      }
      else
      {
        ...
        mScroll.AnimateBy( Property( mActor[i], Actor::Property::POSITION), Vector3( -12.0f*stageSize.x,0.0f, 0.0f));
      }
    }
    mScroll.Play();
