...
Dali::PixelData LoadPixelData( const char*imagePath, bool StageFilling )
{
...
Dali::Atlas LoadImage( const char* imagePath, bool StageFilling = false )
{

  Dali::PixelData pixelData = LoadPixelData(imagePath, false);
...
Dali::Texture LoadTexture( const char* imagePath, bool StageFilling = false )
{
  Dali::BitmapLoader loader;
  if( StageFilling )
  {
