                        ...
                        const ViewStyle& style = DEFAULT_VIEW_STYLE )
{
  ...
  {
    Dali::Image backgroundImage = Dali::ResourceImage::New( backgroundImagePath, Dali::ImageDimensions( stage.GetSize().x, stage.GetSize().y ), Dali::FittingMode::ScaleToFill, Dali::SamplingMode::BoxThenLinear );
