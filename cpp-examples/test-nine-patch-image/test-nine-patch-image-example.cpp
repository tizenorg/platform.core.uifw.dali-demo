...
#define USE_NINEPATCHIMAGE
#define USE_IMAGEVIEW
  ...
  void Create( Application& application )
  {
    ...
    //const string imagePath = DALI_IMAGE_DIR "gallery-small-1.jpg";
    const string imagePath = DALI_IMAGE_DIR "button-down.9.png";
    //const string imagePath = "http://cdn.dibbus.com/wp-content/uploads/2011/03/btn_red_matte.9.png";

#ifdef USE_NINEPATCHIMAGE
    NinePatchImage image = NinePatchImage::New( imagePath );
#else
    ResourceImage image = ResourceImage::New( imagePath );
#endif

    image.LoadingFinishedSignal().Connect(this, &HelloWorldController::OnLoadFinished); 
