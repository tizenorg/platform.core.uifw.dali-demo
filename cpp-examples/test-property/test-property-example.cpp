...
void Create( Application& application )
{
  ...
  Property::Value actorDesc = "Specialized label";
  actor.RegisterProperty( "description", actorDesc, Property::READ_WRITE );
  Property::Value actorMarked = true;
  actor.RegisterProperty( "marked", actorMarked, Property::READ_WRITE );

  std::cout << actor.GetProperty( actor.GetPropertyIndex( "description" ) ) << std::endl;
  std::cout << actor.GetProperty( actor.GetPropertyIndex( "marked" ) ) << std::endl;
  }
