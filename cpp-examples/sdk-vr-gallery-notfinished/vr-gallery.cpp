...
//    char short_buf[256];
//    const size_t needed = vsprintf(short_buf, sizeof short_buf,format, arg_list) + 1;
//    if (needed <= sizeof short_buf)
//        return short_buf;
//
//    // need more space...
//    char* p = static_cast<char*>(alloca(needed));
//    vsprintf(p, needed, format, arg_list);
//    return p;
}
...
#define DALI_IMAGE_DIR "/opt/usr/apps/$(packageName)/res/images/"
...
//            ani.MoveBy(curGroup, HOVER_MOVE, AlphaFunctions::EaseInOut);
            ani.AnimateTo(Property( curGroup, Actor::Property::SCALE ), Vector3(GROUP_SCALE*HOVER_SCALE,);
            ani.AnimateBy(Property( curGroup, Actor::Property::POSITION ), HOVER_MOVE);
          }
          if(prevGroup)
          {
...
//            ani.MoveBy(curActor, HOVER_MOVE, AlphaFunctions::EaseInOut);
             ani.AnimateTo(Property( actor, Actor::Property::SCALE ), Vector3(HOVER_SCALE,HOVER_SCALE,1));
             ani.AnimateBy(Property( actor, Actor::Property::POSITION ), HOVER_MOVE);
          }
...
//            ani.MoveBy(prevActor, -HOVER_MOVE, AlphaFunctions::EaseInOut);
              ani.AnimateTo(Property( actor, Actor::Property::SCALE ), Vector3(1,1,1));
              ani.AnimateBy(Property( actor, Actor::Property::POSITION ), -HOVER_MOVE);
          }
          ani.Play();
        }
