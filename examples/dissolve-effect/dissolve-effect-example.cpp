...
void DissolveEffectApp::OnInit( Application& application )
{
  ...
  mEffectChangeButton.SetButtonImage( EFFECT_HIGHP_IMAGE );
  ...
  mPlayStopButton.SetButtonImage( PLAY_ICON );
...
bool DissolveEffectApp::OnEffectButtonClicked( Toolkit::Button button )
{
  ...
  else
  {
    ...
    mEffectChangeButton.SetButtonImage( EFFECT_MEDIUMP_IMAGE );
...
bool DissolveEffectApp::OnSildeshowButtonClicked( Toolkit::Button button )
{
  ...
  if( mSlideshow )
  {
    mPlayStopButton.SetButtonImage( STOP_ICON );
