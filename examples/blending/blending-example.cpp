...
const char* MATERIAL_SAMPLE( DALI_IMAGE_DIR "blocks-ball.png" );
...
class BlendingController: public ConnectionTracker
{
 public:
  ...
  void Create( Application& application )
  {
    ...
    mImage2 = Toolkit::ImageView::New( MATERIAL_SAMPLE );
    mImage2.SetSize( Vector2( 300, 300 ) );
    mImage2.SetParentOrigin( ParentOrigin::BOTTOM_LEFT );
    mImage2.SetAnchorPoint( AnchorPoint::CENTER );
    mContentLayer.Add( mImage2 );
