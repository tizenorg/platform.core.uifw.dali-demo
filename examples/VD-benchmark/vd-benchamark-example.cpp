...
public:
  ...
  void setPosition()
  {
    ...
    //Load Image
    image[0] = ResourceImage::New(IMAGE_PATH"folder_icon.png");
    image[1] = ResourceImage::New(IMAGE_PATH"bg1.jpg");
    image[2] = ResourceImage::New(IMAGE_PATH"bg2.jpg");
    image[3] = ResourceImage::New(IMAGE_PATH"bg3.jpg");
    image[4] = ResourceImage::New(IMAGE_PATH"bg4.jpg");
    image[5] = ResourceImage::New(IMAGE_PATH"bg5.jpg");
    ...
    stage.Add( container_actor );
  	...
  	for(int i=0; i<no_actor; ++i)
  	{
  		...
  		Control     widget; 
      ImageActor  actor_folder, actor_bg_image;
  		TextLabel   text;
      ...
      widget.SetBackgroundColor(Vector4(0.0f, 0.0f, 1.0f, 1.0f));
  ...
  void Create( Application& application )
  {
    ...
    Image bgImage = ResourceImage::New(IMAGE_PATH"focus.png");
    ...
    border.SetStyle( ImageActor::STYLE_NINE_PATCH );
    border.SetNinePatchBorder( Vector4(9.0f, 9.0f, 9.0f, 9.0f) );
