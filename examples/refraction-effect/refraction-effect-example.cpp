 ...
 ************************************************************************************************/
const char* VERTEX_SHADER_FLAT = MAKE_SHADER(
...
void main()\n
{\n
  gl_Position = uMvpMatrix * vec4( aPosition.xy, 0.f, 1.0 );\n
  vTexCoord = aTexCoord.xy;\n
}\n
);

const char* FRAGMENT_SHADER_FLAT = MAKE_SHADER(
precision mediump float;\n
 ...
 ************************************************************/
const char* VERTEX_SHADER_REFRACTION = MAKE_SHADER(
precision mediump float;\n
attribute mediump vec3    aPosition;
attribute mediump vec3    aNormal;
attribute highp   vec2    aTexCoord;
...
const char* FRAGMENT_SHADER_REFRACTION = MAKE_SHADER(
precision mediump float;\n
...
private:
  ...
  void Create(Application& application)
  {
    ...
    mMeshActor.AddUniformMapping( mLightXYOffsetIndex, std::string("uLightXYOffset") );
    ...
    mMeshActor.AddUniformMapping( lightPositionIndex,  std::string("uLightPosition"));
