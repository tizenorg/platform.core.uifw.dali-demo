...
//    mGround = ImageActor::New(brickWall);
//    mGround.SetParentOrigin(ParentOrigin::CENTER);
//    mGround.SetAnchorPoint(AnchorPoint::CENTER);
//    mGround.SetName("Plane");
//    mGround.SetSize(1000.0f, 1000.0f);
//    mGround.SetRotation( Degree(90.0f), Vector3(1.0,0.0,0.0));
//    mGround.SetPosition(Vector3(0.0f, 400.0f, -500.0f));
//    stage.Add( mGround );
  ...
  void ModelReady()
  {
    ...
    if (rootActor)
    {
      ...
      if( cube )
      {
        ...
        cube.SetPosition( -100.0f, 0.0f, 0.0f );
        stage.Add( cube );
        ...
        mAnimation[0].AnimateTo( Property( cube, Actor::POSITION_Z), -1500.0f, AlphaFunctions::EaseInOut,TimePeriod( 0.0f,0.5f*duration));
        mAnimation[0].AnimateTo( Property( cube, Actor::POSITION_Z), 0.0f, AlphaFunctions::EaseInOut, TimePeriod( 0.5f*duration,0.5f*duration) );
      ...
      if( torus )
      {
        ...
        torus.SetRotation( Degree(0.0f),Vector3(1.0f,1.0f,1.0f ) );
        stage.Add( torus );
