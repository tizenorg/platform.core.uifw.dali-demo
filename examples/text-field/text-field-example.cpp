...
public:
  ...
  void SetUpTextField( TextField& field, std::string& text )
  {
    if ( !field )
    {
      std::cout << "SetUpTextField Creating New TextField" << std::endl;
  ...
  void EditFolderName( ItemData& item)
  {
    ...
    SetUpTextField( mTextField, item.itemName );
