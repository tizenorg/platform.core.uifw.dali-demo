...
const bool ALWAYS_ADD_TO_STAGE   = true;
...
public:
  ...
  void Create( Application& application )
  {
    ...
    mSceneGraph.push_back( QuickQuad( Quad( 25.0f, 100.0f, 350.0f, 200.0f ), 0.0f, false, 0 ) );     // 1

    mSceneGraph.push_back( QuickQuad( Quad( 30.0f, 105.0f, 340.0f, 190.0f ), 0.0f, true, 1 ) );       // 2
    mSceneGraph.push_back( QuickQuad( Quad( -40.0f, -200.0f, 400.0f, 400.0f ), 0.0f, false, 2 ) );   // 3

#if 1
    mSceneGraph.push_back( QuickQuad( Quad( 35.0f, 110.0f - 80.0f, 162.5f, 180.0f ), 0.0f, true, 3 ) );      // 4
#endif
#if 1
    mSceneGraph.push_back( QuickQuad( Quad( 0.0f, 0.0f + 0.0f, 400.0f, 400.0f ), 0.0f, false, 4 ) );        // 5
#endif
#if 1
    mSceneGraph.push_back( QuickQuad( Quad( -116.25f, -200.0f, 400.0f, 100.0f ), 0.0f, false, 5 ) ); // 6
#endif
#if 1
    mSceneGraph.push_back( QuickQuad( Quad( 116.25f, 110.0f - 10.0f, 81.25f, 90.0f ), 0.0f, true, 6 ) );     // 7
#endif
#if 1
    mSceneGraph.push_back( QuickQuad( Quad( -81.25f, -245.0f, 400.0f, 50.0f ), 0.0f, false, 7 ) );   // 8
#endif

#if 0
    mSceneGraph.push_back( QuickQuad( Quad( 202.5f, 110.0f, 262.5f, 180.0f ), 0.0f, true, 2 ) );     // (2) 9
    mSceneGraph.push_back( QuickQuad( Quad( 0.0f, 0.0f, 400.0f, 140.0f ), 0.0f, false, 9 ) );        // (2) 10
#endif
