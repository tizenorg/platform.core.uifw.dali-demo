...
public:
  ...
  void OnInit(Application& app)
  {
    ...
    mFlexContainer.SetProperty(FlexContainer::Property::FLEX_DIRECTION, FLEX_DIRECTION[2]); // column as main axis
    ...
    // Update the title
    std::string value( FLEX_DIRECTION[mCurrentFlexDirection] );
    SetTitle( "Flex direction", value );
  }

  bool OnFlexDirectionButtonClicked( Toolkit::Button button )
  {
    mCurrentFlexDirection = ( mCurrentFlexDirection + 1 ) % NUM_FLEX_DIRECTION;
    mFlexItemContainer.SetProperty(FlexContainer::Property::FLEX_DIRECTION, FLEX_DIRECTION[mCurrentFlexDirection]);
    std::string value( FLEX_DIRECTION[mCurrentFlexDirection] );
    SetTitle( "Flex direction", value );
  ...
  {
    mCurrentFlexWrap = ( mCurrentFlexWrap + 1 ) % NUM_FLEX_WRAP;
    mFlexItemContainer.SetProperty(FlexContainer::Property::FLEX_WRAP, FLEX_WRAP[mCurrentFlexWrap]);
    std::string value( FLEX_WRAP[mCurrentFlexWrap] );
    SetTitle( "Flex wrap", value );
  ...
  {
    mCurrentJustifyContent = ( mCurrentJustifyContent + 1 ) % NUM_JUSTIFY_CONTENT;
    mFlexItemContainer.SetProperty(FlexContainer::Property::JUSTIFY_CONTENT, JUSTIFY_CONTENT[mCurrentJustifyContent]);
    std::string value( JUSTIFY_CONTENT[mCurrentJustifyContent] );
    SetTitle( "Justify content", value );
  ...
  {
    mCurrentAlignItems = ( mCurrentAlignItems + 1 ) % NUM_ALIGN_ITEMS;
    mFlexItemContainer.SetProperty(FlexContainer::Property::ALIGN_ITEMS, ALIGN_ITEMS[mCurrentAlignItems]);
    std::string value( ALIGN_ITEMS[mCurrentAlignItems] );
    SetTitle( "Align Items", value );
  ...
  {
    mCurrentAlignContent = ( mCurrentAlignContent + 1 ) % NUM_ALIGN_CONTENT;
    mFlexItemContainer.SetProperty(FlexContainer::Property::ALIGN_CONTENT, ALIGN_CONTENT[mCurrentAlignContent]);
    std::string value( ALIGN_CONTENT[mCurrentAlignContent] );
    SetTitle( "Align content", value );
