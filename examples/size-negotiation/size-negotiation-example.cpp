...
public:
  ...
  bool OnButtonClicked( Toolkit::Button button )
  {
    ...
    else if( button.GetName() == POPUP_BUTTON_CONTENT_TEXT_ID )
    {
      ...
      text.SetPadding( Actor::Padding( 20.0f, 20.0f, 20.0f, 20.0f ) );
    ...
    else if( button.GetName() == POPUP_BUTTON_CONTENT_IMAGE_ID )
    {
      ...
      image.SetPadding( Actor::Padding( 20.0f, 20.0f, 20.0f, 20.0f ) );
    ...
    else if( button.GetName() == POPUP_BUTTON_TITLE_CONTENT_TEXT_BUTTONS_ID )
    {
      ...
      text.SetResizePolicy( FILL_TO_PARENT, WIDTH );
      text.SetDimensionDependency( HEIGHT, WIDTH );
      text.SetPadding( Actor::Padding( 10.0f, 10.0f, 20.0f, 0.0f ) );
    ...
    else if( button.GetName() == POPUP_BUTTON_COMPLEX_ID )
    {
      ...
      content.SetPadding( Actor::Padding( 20.0f, 20.0f, 20.0f, 0.0f ) );
      ...
      // Image
      {
        ...
        image.SetResizePolicy( FILL_TO_PARENT, WIDTH );
        image.SetDimensionDependency( HEIGHT, WIDTH );
        image.SetPadding( Actor::Padding( 20.0f, 0.0f, 0.0f, 0.0f ) );
      ...
      // Text 2
      {
        ...
        root.SetFitHeight( 0 );
        root.SetFitWidth( 0 );
        root.SetPadding( Actor::Padding( 0.0f, 0.0f, 0.0f, 20.0f ) );
        ...
        textActor.SetPadding( Actor::Padding( 20.0f, 0.0f, 0.0f, 10.0f ) );
