...
public:
  ...
  void Create( Application& application )
  {
    ...
    mItemView.SetResizePolicy( FILL_TO_PARENT );
  ...
  bool OnButtonClicked( Toolkit::Button button )
  {
    ...
    else if( button.GetName() == POPUP_BUTTON_CONTENT_TEXT_ID )
    {
      ...
      text.SetPadding( Vector2( 20.0f, 20.0f ) );
    ...
    else if( button.GetName() == POPUP_BUTTON_CONTENT_IMAGE_ID )
    {
      ...
      image.SetPadding( Vector2( 20.0f, 20.0f ) );
    ...
    else if( button.GetName() == POPUP_BUTTON_CONTENT_IMAGE_SCALE_ID )
    {
      ...
      mPopup.SetResizePolicy( FILL_TO_PARENT );
      mPopup.SetRelayoutSizeFactor( Vector3( 0.75f, 0.5f, 1.0f ) );
    ...
    else if( button.GetName() == POPUP_BUTTON_TITLE_CONTENT_TEXT_ID )
    {
      ...
      text.SetResizePolicy( FILL_TO_PARENT, WIDTH );
      text.SetDimensionDependency( HEIGHT, WIDTH );
      text.SetPadding( Vector2( 20.0f, 20.0f ), WIDTH );
      text.SetPadding( Vector2( 20.0f, 0.0f ), HEIGHT );
    ...
    else if( button.GetName() == POPUP_BUTTON_TITLE_CONTENT_TEXT_BUTTONS_ID )
    {
      ...
      text.SetResizePolicy( FILL_TO_PARENT, WIDTH );
      text.SetDimensionDependency( HEIGHT, WIDTH );
      text.SetPadding( Vector2( 10.0f, 10.0f ), WIDTH );
      text.SetPadding( Vector2( 20.0f, 0.0f ), HEIGHT );
    ...
    else if( button.GetName() == POPUP_BUTTON_COMPLEX_ID )
    {
      ...
      content.SetPadding( Vector2( 20.0f, 20.0f ), WIDTH );
      content.SetPadding( Vector2( 20.0f, 0.0f ), HEIGHT );
      ...
      // Image
      {
        ...
        image.SetResizePolicy( FILL_TO_PARENT, WIDTH );
        image.SetDimensionDependency( HEIGHT, WIDTH );
        image.SetPadding( Vector2( 20.0f, 0.0f ), WIDTH );
      ...
      // Text 2
      {
        ...
        root.SetFitHeight( 0 );
        root.SetFitWidth( 0 );
        root.SetPadding( Vector2( 0.0f, 20.0f ), HEIGHT );
        ...
        checkBox.SetResizePolicy( FIXED );
        ...
        textActor.SetPadding( Vector2( 20.0f, 0.0f ), WIDTH );
        textActor.SetPadding( Vector2( 0.0f, 10.0f ), HEIGHT );
    ...
    else if( button.GetName() == TABLEVIEW_BUTTON_EMPTY_ID )
    {
      mPopup = CreatePopup();
      mPopup.SetResizePolicy( FILL_TO_PARENT );
      mPopup.SetRelayoutSizeFactor( Vector3( 0.75f, 0.75f, 1.0f ) );

      Toolkit::TableView table = Toolkit::TableView::New( 0, 0 );
      table.SetResizePolicy( FILL_TO_PARENT );
    ...
    else if( button.GetName() == TABLEVIEW_BUTTON_1CELL_ID )
    {
      ...
      backing.SetResizePolicy( FILL_TO_PARENT );
      table.Add( backing );
    ...
    else if( button.GetName() == TABLEVIEW_BUTTON_FIT2_ID )
    {
      ...
      }
      {
        ...
        backing.SetResizePolicy( FILL_TO_PARENT, WIDTH );
        backing.SetResizePolicy( FIXED, HEIGHT );
        backing.SetPreferredSize( Vector2( 0.0f, 400.0f ) );
    ...
    else if( button.GetName() == TABLEVIEW_BUTTON_NATURAL1_ID )
    {
      ...
      mPopup.SetRelayoutSizeFactor( Vector3( 0.75f, 1.0f, 1.0f ) );
...
public: // From ItemFactory
  ...
  virtual Actor NewItem(unsigned int itemId)
  {
    ...
    if( buttonDataArray )
    {
      ...
      popupButton.SetResizePolicy( USE_NATURAL_SIZE );
