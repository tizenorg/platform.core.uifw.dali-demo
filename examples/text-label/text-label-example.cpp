...
public:
  ...
  void Create( Application& application )
  {
    ...
    TextLabel rtlLabel = TextLabel::New( "مرحبا بالعالم");

    SetUpLabel( mLabel, "TextLabel" );
    SetUpLabel( smallLabel, "smallLabel" );
    SetUpLabel( rtlLabel, "rtlLabel" );

    mContainer.Add( mLabel );
    containerTwo.Add( smallLabel );
    containerThree.Add( rtlLabel );
