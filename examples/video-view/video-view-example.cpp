...
class VideoViewController: public ConnectionTracker
{
 public:
  ...
  void Create( Application& application )
  {
    ...
    mPlayPauseButton.SetSize( BUTTON_SIZE, BUTTON_SIZE );
    mPlayPauseButton.SetPosition( 40, 10 );
    ...
    mStopResetButton.SetSize( BUTTON_SIZE, BUTTON_SIZE );
    mStopResetButton.SetPosition( 140, 10 );
