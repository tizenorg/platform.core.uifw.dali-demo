...
class VideoViewController: public ConnectionTracker
{
 public:
  ...
  void Create( Application& application )
  {
    ...
    mVideoView = Toolkit::VideoView::New( PLAY_FILE );
    ...
    mPlayButton.SetResizePolicy( ResizePolicy::USE_NATURAL_SIZE, Dimension::ALL_DIMENSIONS );
    ...
    mStopButton.SetResizePolicy( ResizePolicy::USE_NATURAL_SIZE, Dimension::ALL_DIMENSIONS );
    ...
    mMuteButton.SetResizePolicy( ResizePolicy::USE_NATURAL_SIZE, Dimension::ALL_DIMENSIONS );
    ...
    mLoopingButton.SetResizePolicy( ResizePolicy::USE_NATURAL_SIZE, Dimension::ALL_DIMENSIONS );
    ...
    mBackwardButton.SetResizePolicy( ResizePolicy::USE_NATURAL_SIZE, Dimension::ALL_DIMENSIONS );
  ...
  {
    PushButton pushButton = PushButton::DownCast( button );
    ...
    else if( mLoopingButton.GetId() == pushButton.GetId())
    {
      ...
      {
        mIsLooping = false;
        mVideoView.SetProperty( VideoView::Property::LOOPING, false );
