...
"}\n"
"ivec3\n"
"glyphy_float_to_three_nimbles (const float v)\n"
"{\n"
"  int f = glyphy_float_to_byte (v);\n"
"  int x = f / 64;\n"
"  int y = int(mod (float(f), 64.) / 8.);\n"
"  int z = int(mod (float(f), 8.));\n"
"  return ivec3 (x,y,z);\n"
"}\n"
"\n"
...
"\n"
"glyphy_arc_endpoint_t\n"
"glyphy_arc_endpoint_decode_2 (const vec4 v, const ivec2 nominal_size)\n"
"{\n"
"  ivec3 higher_bits = glyphy_float_to_three_nimbles (v.a);"
"  vec2 p = (vec2 (higher_bits.yz) + v.gb) / 8.;\n"
"  float d = (v.r + float(higher_bits.x));\n"
"  if (d == 0.)\n"
"    d = GLYPHY_INFINITY;\n"
"  else\n"
"#define GLYPHY_MAX_D .5\n"
"    d = float(glyphy_float_to_byte (d) - 512) * GLYPHY_MAX_D / 511.;\n"
"#undef GLYPHY_MAX_D\n"
"  return glyphy_arc_endpoint_t (p * vec2(nominal_size), d);\n"
"}\n"
"\n"
