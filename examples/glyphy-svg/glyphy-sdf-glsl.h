...
"  endpoint_prev = glyphy_arc_endpoint_decode_2 (GLYPHY_SDF_TEXTURE1D (arc_list.offset), nominal_size);\n"
"  for (int i = 1; i < arc_list.num_endpoints; i++)\n"
"  {\n"
"    if (i >= arc_list.num_endpoints) {\n"
"      break;\n"
"    }\n"
"    endpoint = glyphy_arc_endpoint_decode_2 (GLYPHY_SDF_TEXTURE1D (arc_list.offset + i), nominal_size);\n"
...
"  for (int i = 0; i < arc_list.num_endpoints; i++)\n"
"  {\n"
"    if (i >= arc_list.num_endpoints) {\n"
"      break;\n"
"    }\n"
