              ...
              const glyphy_extents_t *extents2)
{
 ...
 /* return !(extents2.left > extents1.right
        || extents2.right < extents1.left
        || extents2.top > extents1.bottom
        || extents2.bottom < extents1.top);*/

  return !(extents2->min_x >= extents1->max_x
        || extents2->max_x <= extents1->min_x
        || extents2->max_y <= extents1->min_y
        || extents2->min_y >= extents1->max_y);
}
