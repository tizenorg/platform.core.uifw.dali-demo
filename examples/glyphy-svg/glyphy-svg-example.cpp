...
{
  DALI_IMAGE_DIR "american eagle.svg",
  DALI_IMAGE_DIR "Welsh_dragon.svg",
  DALI_IMAGE_DIR "beakman_Blue_eye.svg",
  DALI_IMAGE_DIR "us_capitol_building_cli_01.svg",
  DALI_IMAGE_DIR "Anonymous_Martin_Luther_King_Jr_03.svg",
  DALI_IMAGE_DIR "eleven_below_single.svg",
  DALI_IMAGE_DIR "cake1_jarno_vasamaa_01.svg",
  DALI_IMAGE_DIR "bookstack.svg",
  DALI_IMAGE_DIR "buggi_intricate_letter_A.svg",
...
public:
  ...
  {
    // Load
    GlyphyAtlas* glyphyAtlas = new GlyphyAtlas( 1024, 512, 64, 8 );
