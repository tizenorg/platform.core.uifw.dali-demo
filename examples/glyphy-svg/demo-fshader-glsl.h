...
"    else{\n"
"      int idx = int(v_gradient_index+0.5)*6;\n;"
"      float _y = u_gradient_info[idx+3]*v_position[0]-u_gradient_info[idx+4]*v_position[1]+u_gradient_info[idx+5];\n"
"      float lookup_x;"
"      if( abs(u_gradient_info[idx])+abs(u_gradient_info[idx+1])+ abs(u_gradient_info[idx+2])< GLYPHY_EPSILON )\n"
"      { lookup_x = clamp(_y, 0.0, 1.0);}\n "
"      else{\n"
"        float _x = u_gradient_info[idx]*v_position[0]-u_gradient_info[idx+1]*v_position[1]+u_gradient_info[idx+2];\n"
