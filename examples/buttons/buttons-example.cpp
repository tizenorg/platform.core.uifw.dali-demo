...
class ButtonsController: public ConnectionTracker
{
 public:
  ...
  void Create( Application& application )
  {
    ...
    checkBoxBackground.SetSize( DP(430), DP(group3Height) );
    ...
    yPos += group3Height + MARGIN_SIZE;
    const int group4Height = RADIO_IMAGE_HEIGHT + MARGIN_SIZE * 2;
    ...
    toggleBackground.SetSize( DP(150 + MARGIN_SIZE * 2), DP(group4Height) );
    ...
    toggleButton.SetSize( DP(150), DP(RADIO_IMAGE_HEIGHT) );
