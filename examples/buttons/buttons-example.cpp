...
//    contentTable.TouchedSignal().Connect( this, &ButtonsController::OnTouchEvent );
    ...
    // Radio 1
    {
      Toolkit::ImageView imageView = Toolkit::ImageView::New( ResourceImage::New( SMALL_IMAGE_1 ) );
    ...
    // Radio 2
    {
      ...
      Toolkit::ImageView imageView = Toolkit::ImageView::New( ResourceImage::New( SMALL_IMAGE_2 ) );
      imageView.SetSize( DP(RADIO_LABEL_THUMBNAIL_SIZE), DP(RADIO_LABEL_THUMBNAIL_SIZE) );
    ...
    // Radio 3
    {
      ...
      Toolkit::ImageView imageView = Toolkit::ImageView::New( ResourceImage::New( SMALL_IMAGE_3 ) );
      imageView.SetSize( DP(RADIO_LABEL_THUMBNAIL_SIZE), DP(RADIO_LABEL_THUMBNAIL_SIZE) );
    ...
    // First radio button
    {
      ...
      Toolkit::ImageView imageView = Toolkit::ImageView::New( ResourceImage::New( ENABLED_IMAGE ) );
      imageView.SetSize( DP(RADIO_LABEL_THUMBNAIL_SIZE), DP(RADIO_LABEL_THUMBNAIL_SIZE) );
