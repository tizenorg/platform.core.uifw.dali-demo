...
class ButtonsController: public ConnectionTracker
{
 public:
  ...
  bool OnButtonClicked(Toolkit::Button button)
  {
    ...
    {
      mImage.SetProperty( Toolkit::ImageView::Property::IMAGE, BIG_IMAGE_1 );
    }
    else if( mRadioButtonImage2.IsSelected() )
    {
      mImage.SetProperty( Toolkit::ImageView::Property::IMAGE, BIG_IMAGE_2 );
    }
    else if( mRadioButtonImage3.IsSelected() )
    {
      mImage.SetProperty( Toolkit::ImageView::Property::IMAGE, BIG_IMAGE_3 );
    }
    return true;
  }
