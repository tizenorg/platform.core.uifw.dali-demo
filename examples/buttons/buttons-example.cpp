...
class ButtonsController: public ConnectionTracker
{
 public:
  ...
  bool OnButtonSelected( Toolkit::Button button, bool state )
  {
  ...
  bool EnableSelectButton( Toolkit::Button button, bool state )
  {
  ...
  bool OnCheckBoxesSelected( Toolkit::Button button, bool state )
  {
