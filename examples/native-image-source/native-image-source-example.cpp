...
Geometry CreateQuadMesh()
{
  ...
  static const VertexWithTexture gQuadWithTexture[] = {{ Vector2( -0.5f, -0.5f ), Vector2( 0.0f, 0.0f ) },
 ...
 */
Actor CreateImageRenderer( Texture texture, NativeImageInterface& nativeImageInterface )
{
  Actor actor = Actor::New();
  Geometry geometry = CreateQuadMesh();
...
public:
  ...
  bool CreateScene()
  {
    ...
    Actor nativeImageActor = CreateImageRenderer( nativeTexture, *nativeImageSourcePtr );
