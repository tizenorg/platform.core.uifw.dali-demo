 ...
 */
Actor CreateNativeImageActor( Texture texture, NativeImageInterface& nativeImageInterface )
{
...
public:
  ...
  bool CreateScene()
  {
    ...
    Actor nativeImageActor = CreateNativeImageActor( nativeTexture, *nativeImageSourcePtr );
