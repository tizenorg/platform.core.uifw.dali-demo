...
const char* TEST_IMAGE_1( DEMO_IMAGE_DIR "music-libray-star.png" );
const char* TEST_IMAGE_2( DEMO_IMAGE_DIR "Kid1.svg" );
                                       ...
                                       int size )
{
  ...
  textActor.SetProperty(  TextLabel::Property::POINT_SIZE, DemoHelper::ScalePointSize(20.f) );
