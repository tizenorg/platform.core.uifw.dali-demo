...
void EffectsViewApp::CreateDropShadowScene()
{
  ...
  CreateDropShadow( Vector2(0.0f, effectSize.height * 1.0f ), effectSize, White, Cyan,  Blue, Black, Vector2(2.0f, 2.0f), 0, true );
  CreateDropShadow( Vector2(0.0f, effectSize.height * 2.0f ), effectSize, Black, White,Orange, Magenta,  Vector2(2.0f, 2.0f), 1, true );
  CreateDropShadow( Vector2(0.0f, effectSize.height * 3.0f ), effectSize, White, Cyan, Blue, Orange,  Vector2(2.0f, 2.0f), 2, true );
  CreateDropShadow( Vector2(0.0f, effectSize.height * 4.0f ), effectSize, Cyan,  White, Green,Black,  Vector2(2.0f, 2.0f), 3, true );
  CreateDropShadow( Vector2(0.0f, effectSize.height * 5.0f ), effectSize, Blue,  Black, Magenta, White,   Vector2(2.0f, 2.0f), 4, true );
}
...
void EffectsViewApp::ChangeView()
{
  TearDownScene();
...
bool EffectsViewApp::OnView( Toolkit::Button button )
{
  ChangeView();
  return true;
}
...
void EffectsViewApp::OnAppInitialize( Application& application )
{
  ...
  Stage::GetCurrent().KeyEventSignal().Connect(this, &EffectsViewApp::OnKeyEvent);
  ...
  viewButton.ClickedSignal().Connect( this, &EffectsViewApp::OnView );
