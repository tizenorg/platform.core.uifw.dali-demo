...
public:
  ...
  Toolkit::EffectsView CreateDropShadow( const Vector2& position, const Vector2& panelSize,
...
private:
  ...
  Toolkit::EffectsView  mDropShadow1;
  Toolkit::EffectsView  mDropShadow2;
  Toolkit::EffectsView  mDropShadow3;
  Toolkit::EffectsView  mDropShadow4;
  Toolkit::EffectsView  mDropShadow5;
  Toolkit::EffectsView  mEmboss;
};
...
void ExampleApp::CreateDropShadowScene()
{
  ...
  mDropShadow1 = CreateDropShadow( Vector2(0.0f, effectSize.height * 0.0f ), effectSize, White, Cyan,  Black,  Vector2(2.0f, 2.0f), 0, false );
  mDropShadow2 = CreateDropShadow( Vector2(0.0f, effectSize.height * 1.0f ), effectSize, Black, White, Orange, Vector2(2.0f, 2.0f), 1, false );
  mDropShadow3 = CreateDropShadow( Vector2(0.0f, effectSize.height * 2.0f ), effectSize, White, Cyan,  Orange, Vector2(2.0f, 2.0f), 2, false );
  mDropShadow4 = CreateDropShadow( Vector2(0.0f, effectSize.height * 3.0f ), effectSize, Cyan,  White, Black,  Vector2(2.0f, 2.0f), 3, true );
  mDropShadow5 = CreateDropShadow( Vector2(0.0f, effectSize.height * 4.0f ), effectSize, Blue,  Black, White,  Vector2(2.0f, 2.0f), 4, true );
}

Toolkit::EffectsView ExampleApp::CreateDropShadow( const Vector2& position, const Vector2& panelSize,
                               const Vector4& foregroundColor, const Vector4& backgroundColor, const Vector4& shadowColor,
...
void ExampleApp::OnKeyEvent(const KeyEvent& event)
{
  if(event.state == KeyEvent::Down)
  {
    ...
    else
    {
      ...
      {
        mViewSize *=0.9f;
        mDropShadow1.SetSize(mViewSize);
        //mDropShadow1.Refresh();
        mDropShadow2.SetSize(mViewSize);
        //mDropShadow2.Refresh();
        mDropShadow3.SetSize(mViewSize);
        //mDropShadow3.Refresh();
        mDropShadow4.SetSize(mViewSize);
        //mDropShadow4.Refresh();
        mDropShadow5.SetSize(mViewSize);
        //mDropShadow5.Refresh();
      }
