...
const Dali::FittingMode::Type DEFAULT_SCALING_MODE = Dali::FittingMode::ScaleToFill;
...
#endif
  Image image = ResourceImage::New( filename, ImageDimensions( width, height ), fittingMode, Dali::SamplingMode::BoxThenLinear );
...
{
  Dali::FittingMode::Type newMode = FittingMode::ShrinkToFit;
  switch ( oldMode )
  {
    case FittingMode::ShrinkToFit:
      newMode = FittingMode::ScaleToFill;
      break;
    case FittingMode::ScaleToFill:
      newMode = FittingMode::FitWidth;
      break;
    case FittingMode::FitWidth:
      newMode = FittingMode::FitHeight;
      break;
    case FittingMode::FitHeight:
      newMode = FittingMode::ShrinkToFit;
      break;
  }
  return newMode;
}
  ...
  bool OnToggleScalingTouched( Button button )
  {
    ...
    for( unsigned i = 0; i < numChildren; ++i )
    {
      ...
      if( gridImageActor )
      {
        ...
        SetTitle( std::string( newMode == FittingMode::ShrinkToFit ? "ShrinkToFit" : newMode == FittingMode::ScaleToFill ?  "ScaleToFill" : newMode == FittingMode::FitWidth ? "FitWidth" : "FitHeight" ) );
      }
    }
    return true;
  }
