...
namespace
{
const char* IMAGE_PATH[] = { DALI_IMAGE_DIR "gallery-large-4.jpg",
  ...
  void Create( Application& application )
  {
    ...
    for( int i=0; i<3;i++ )
      for( int j=0; j<3; j++ )
      {
        ...
        mImageView[i][j].SetProperty( Toolkit::ImageView::Property::PIXEL_AREA, Toolkit::ImageView::PixelArea( subSize*i, subSize*j, subSize, subSize ) );
      }
