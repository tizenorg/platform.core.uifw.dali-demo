...
void ImageActorExample::CreateClampScene()
{
  Stage stage = Stage::GetCurrent();
...
//    image.SetFilterMode( Image::FILTER_NEAREST, Image::FILTER_NEAREST );
    mImageActor = ImageActor::New( image );
//    mImageActor.SetFilterMode( FilterMode::LINEAR, FilterMode::LINEAR );
...
//    image.SetFilterMode( Image::FILTER_NEAREST, Image::FILTER_NEAREST );
...

  {
    // Bottom image left
    Image image = Image::New( TEST_IMAGE_FILENAME );
//    image2.SetFilterMode( Image::FILTER_LINEAR, Image::FILTER_LINEAR );
...
//    mImageActor3.SetFilterMode( FilterMode::LINEAR, FilterMode::LINEAR );
...
//  image.SetFilterMode( Image::FILTER_LINEAR, Image::FILTER_LINEAR );
