 ...
 * There are dedicated buttons for changing the models and the shaders and pausing the animations.
...
public:
  ...
  void Create( Application& application )
  {
    ...
    int width = mButtonLayer.GetRelayoutSize(Dimension::WIDTH);
    width++;
    ...
    //Create animations
    mLightAnimationLeft = Animation::New(6.f);
    mLightAnimationLeft.AnimateTo(Property(mModel3dView, Model3dView::Property::LIGHTPOSITION), Vector3(-5,10.0,0), TimePeriod( 0.0f, 3.0f ));
    mLightAnimationLeft.SetLooping(true);
    mLightAnimationLeft.Play();

    mLightAnimationRight = Animation::New(6.f);
    mLightAnimationRight.AnimateTo(Property(mModel3dView, Model3dView::Property::LIGHTPOSITION), Vector3(5,10.0,0), TimePeriod( 3.0f, 3.0f ));
    mLightAnimationRight.SetLooping(true);
    mLightAnimationRight.Play();
  ...
  void PauseAnimations()
  {
    if( mPlaying )
    {
      ...
      mLightAnimationLeft.Pause();
      mLightAnimationRight.Pause();
...
private:
  ...
  Animation mLightAnimationLeft;
  Animation mLightAnimationRight;
  bool mPlaying;
};
