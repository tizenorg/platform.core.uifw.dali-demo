...
public:
  ...
  void Create( Application& application )
  {
    ...
    lightAnimation.AnimateTo(Property(mModel3dView, Model3dView::Property::LIGHTPOSITION), Vector3(-5,10.0,0) );
    lightAnimation.SetLooping(false);
    lightAnimation.Play();

    lightAnimation.FinishedSignal().Connect( this, &Model3dViewController::EndFirstAnimation );
  ...
  void EndFirstAnimation(Animation &source)
  {
    //Create animations
    Animation lightAnimation = Animation::New(3.f);
    lightAnimation.AnimateTo(Property(mModel3dView, Model3dView::Property::LIGHTPOSITION), Vector3(5,10.0,0) );
    ...
    lightAnimation.FinishedSignal().Connect( this, &Model3dViewController::EndSecondAnimation );
  }

  void EndSecondAnimation(Animation &source)
  {
    //Create animations
    Animation lightAnimation = Animation::New(3.f);
    lightAnimation.AnimateTo(Property(mModel3dView, Model3dView::Property::LIGHTPOSITION), Vector3(-5,10.0,0) );
