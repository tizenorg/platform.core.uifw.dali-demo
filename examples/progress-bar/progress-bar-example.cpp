...
public:
  ...
  void Create( Application& application )
  {
    ...
    progressbar.ValueChangedSignal().Connect(this, &ProgressBarExample::OnProgressBarValueChanged );
    ...
    Toolkit::TableView progressBackground = Toolkit::TableView::New( 2, 2 );
    ...
    progressBackground.SetFitHeight( 1 );
    progressBackground.SetFitWidth( 0 );
    ...
    mToggleButton1 = Toolkit::PushButton::New();
    mToggleButton1.SetTogglableButton( true );
    mToggleButton1.SetLabelText( "Reset Progress" );
    mToggleButton1.SetResizePolicy( ResizePolicy::FILL_TO_PARENT, Dimension::WIDTH );
    mToggleButton1.SetResizePolicy( ResizePolicy::USE_NATURAL_SIZE, Dimension::HEIGHT );
    mToggleButton1.StateChangedSignal().Connect( this, &ProgressBarExample::OnButtonSelected1 );

    toggleBackground.Add( mToggleButton1 );
 }

 bool OnButtonSelected1( Toolkit::Button button )
 {
 ...
 bool OnProgressBarValueChanged( ProgressBar slider, float value )
 {
   progressbar.SetProperty(ProgressBar::Property::VALUE, 5.0f);
   return true;
 }
...
private:
  ...
  Toolkit::PushButton mToggleButton1;
};
