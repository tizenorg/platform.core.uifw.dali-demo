         ...
         double           *advance)
{
  ...
  if( !glyphy_svg(outline_decompose)(image, svg->acc) )
...
void
demo_svg_upload( demo_svg_t *svg, NSVGimage* image, glyph_info_t *glyph_info)
{
