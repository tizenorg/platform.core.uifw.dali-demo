...
{
  unsigned int height = (bufferLength + requiredWidth - 1) / requiredWidth;

  BitmapImage bitmap = BitmapImage::New( requiredWidth, height, Dali::Pixel::RGBA8888 );

  PixelBuffer* destBuffer = bitmap.GetBuffer();
