...
public:
  ...
  void LoadScene()
  {
    ...
    for( int i = 0; i < MAX_PROPERTIES; i++ )
    {
      ...
      slider.SetParentOrigin( Vector3( 0.98, 0.99 - offset, 0.5 ) ); //Offset from bottom right.
      slider.SetAnchorPoint( AnchorPoint::BOTTOM_RIGHT );
      slider.SetResizePolicy( ResizePolicy::SIZE_RELATIVE_TO_PARENT, Dimension::WIDTH );
      slider.SetSizeModeFactor( Vector3( 0.70, 0.0, 0.0 ) );
      ...
      sliderLabel.SetParentOrigin( ParentOrigin::CENTER_LEFT );
      sliderLabel.SetAnchorPoint( AnchorPoint::CENTER_RIGHT );
