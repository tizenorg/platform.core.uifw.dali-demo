...
//    ToolBar toolBar;
//    Layer toolBarLayer = DemoHelper::CreateToolbar( toolBar, TOOLBAR_IMAGE, APPLICATION_TITLE, DemoHelper::DEFAULT_VIEW_STYLE );
//    stage.Add( toolBarLayer );
//
//    //Add description of demo as subtitle
//    TextLabel textLabel = TextLabel::New( DEMO_DETAILS );
//    textLabel.SetParentOrigin( ParentOrigin::BOTTOM_CENTER );
//    textLabel.SetAnchorPoint( AnchorPoint::BOTTOM_CENTER );
...
//    toolBarLayer.Add( textLabel );
      ...
      details.SetPosition(0.0, DETAILS_OFFSET );
