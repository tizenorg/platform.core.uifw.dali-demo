...
CircularNumber CircularNumber::New( bool reverse )
{
  return Internal::CircularNumber::New( reverse );
}
...
{
  Dali::Toolkit::GetImplementation(*this).Update( num, radius, duration );
}

void CircularNumber::SetReverse( bool reverse )
{
  Dali::Toolkit::GetImplementation(*this).SetReverse( reverse );
}
