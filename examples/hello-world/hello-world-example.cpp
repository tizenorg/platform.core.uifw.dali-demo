...
public:
  ...
  void Create(Application& application)
  {
    ...
    globeRotation = Quaternion(Degree(90.f), Vector3::YAXIS);
    globeRotation *= Quaternion(Degree(180.f), Vector3::ZAXIS);

    globeActor.SetOrientation(globeRotation);

    stage.Add(globeActor);

    Animation anim1 = Animation::New(2.f);
    anim1.SetLooping(true);
    anim1.AnimateTo(Property(globeActor, Actor::Property::ORIENTATION), Quaternion(Degree(90.f), Vector3::YAXIS), AlphaFunction::BOUNCE);
    //anim1.Play();
...
#else
    globeRotation *= Quaternion(Radian(latitude), Vector3::YAXIS);
    globeRotation *= Quaternion(Radian(longitude), worldXAxis);
    //anim.AnimateTo(Property(globeActor, Actor::Property::ORIENTATION), globeRotation, AlphaFunction::BOUNCE);

    anim.AnimateTo(Property(globeActor, Actor::Property::ORIENTATION), globeRotation, AlphaFunction::BOUNCE);
    anim.AnimateTo(Property(globeActor, Actor::Property::SCALE), Vector3(2.5f, 2.5f, 2.5f), AlphaFunction::BOUNCE);
#endif
    anim.Play();
