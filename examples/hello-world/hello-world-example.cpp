...
void main()
{
  ...
  gl_FragColor = vec4( (stepUpper.x+stepUpper.y+stepUpper.z)/255.0, (stepLower.x+stepLower.y+stepLower.z)/255.0, 0.0, 1.0 );
}
);
}
  ...
  Dali::ShaderEffect NewEffect()
  {
    ...
    std::string fragmentShader = DALI_COMPOSE_SHADER(
      ...
      void main()
      {
        ...
        mediump float stepUpper = textureColor.x * 255.0;
        mediump float stepLower = textureColor.y * 255.0;
