...
public:
  ...
  Dali::ShaderEffect NewEffect()
  {
    ...
    std::string fragmentShader = DALI_COMPOSE_SHADER(
      ...
      void main()
      {
        ...
        //mediump vec3 tzColorUpper = vec3(0.0, 1.0, 1.0);
        //mediump vec3 tzColorLower = vec3(0.0, 0.0, 1.0);
        ...
        //mediump vec3 dayColorUpperQuantized = abs(stepUpper - tzColorUpper);
        //mediump vec3 dayColorLowerQuantized = abs(stepLower - tzColorLower);
  ...
  void Create( Application& application )
  {
    ...
    globeActor.RotateBy(Degree(100.f), Vector3::YAXIS);
    globeActor.RotateBy(Degree(180.f), Vector3::ZAXIS);
     ...
     * City
     */
    float latitude = x_coordinate_billboard[155-30] * 3.14f / 180.f;
    float longitude = y_coordinate_billboard[155-30] * 3.14f / 180.f;
    ...
    anim.AnimateBy(Property(globeActor, Actor::Property::ORIENTATION), Quaternion(Radian(longitude), Vector3::XAXIS), AlphaFunction::BOUNCE);
    anim.AnimateBy(Property(globeActor, Actor::Property::SCALE), Vector3(1.5f, 1.5f, 1.5f), AlphaFunction::BOUNCE);
    anim.Play();
