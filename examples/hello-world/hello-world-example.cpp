...
Dali::ShaderEffect NewEffect()
  ...
  void Create( Application& application )
  {
    ...
    ImageActor bgActor = CreateSolidColorActor(Color::RED);
    ...
    Animation anim = Animation::New(3.f - 0.3f);
    anim.SetLooping(true);
    anim.AnimateBy(Property(actor, Actor::Property::ORIENTATION), Quaternion(Radian(Degree(180.f)), Vector3::ZAXIS), AlphaFunction::BOUNCE);
    float duration = 1.5f * 0.5f;
    anim.AnimateTo(Property(effect, "uFanAngle"), 45.f, AlphaFunction::LINEAR, TimePeriod(0.f, duration));
    anim.AnimateTo(Property(effect, "uFanAngle"), 0.f, AlphaFunction::LINEAR, TimePeriod(duration, duration - 0.3f));
    anim.AnimateTo(Property(effect, "uFanAngle"), 45.f, AlphaFunction::LINEAR, TimePeriod(duration * 2 - 0.3f, duration));
    anim.AnimateTo(Property(effect, "uFanAngle"), 0.f, AlphaFunction::LINEAR, TimePeriod(duration * 3 - 0.3f, duration));
    anim.Play();
