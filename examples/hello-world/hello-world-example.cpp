...
public:
  ...
  Dali::ShaderEffect NewEffect()
  {
    ...
    std::string fragmentShader = DALI_COMPOSE_SHADER(
      ...
      {                                                                                       \n                                                                                            \n
        ...
        //flag = step(0.2, flag);                                                             \n
                                                                                              \n
        float continents = (stepColor.r + stepColor.g + stepColor.b);                                                 \n
                                                                                              \n
        //gl_FragColor = vec4(continents, 0.0, 0.0, 1.0); return ;                                            \n
  ...
  void Create( Application& application )
  {
    ...
    effect.SetUniform(TIMEZONE_COLOR_PROPERTY_NAME, timezoneSelColorPart1[mCurrentTimeZone] * 0.5f + timezoneSelColorPart2[mCurrentTimeZone] * 0.5f);
