...
public:
  ...
  void Create( Application& application )
  {
    ...
    actor2.SetDrawMode( DrawMode::OVERLAY_2D );
    ...
    actor4.SetDrawMode( DrawMode::OVERLAY_2D );
    ...
    actor5.SetDrawMode( DrawMode::OVERLAY_2D );
    ...
    actor6.SetDrawMode( DrawMode::OVERLAY_2D );
