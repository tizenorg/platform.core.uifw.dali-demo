...
void main()
{
  ...
  gl_FragColor = vec4( (stepUpper.x+stepUpper.y+stepUpper.z)/3.0, 0.0, 0.0, (stepLower.x+stepLower.y+stepLower.z)/3.0 );
}
);
}
...
public:
  ...
  Dali::ShaderEffect NewEffect()
  {
    ...
    std::string fragmentShader = DALI_COMPOSE_SHADER(
      ...
      void main()
      {
        ...
        mediump float stepUpper = textureColor.r * 3.0;
        mediump float stepLower = textureColor.a * 3.0;
  ...
  FrameBufferImage CreateWorldMapImage()
  {
    ...
    FrameBufferImage frameBufferImage = FrameBufferImage::New( image.GetWidth(), image.GetHeight()* 0.5f, Pixel::LA88, RenderBuffer::COLOR );
