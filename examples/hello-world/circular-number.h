...
public:
   ...
   */
  static CircularNumber New( bool reverse = false );
...
public:
  ...
  /**
   * @brief Update number and radius
   *
   * @param[in] num Number to be updated
   * @param[in] radius Radius of the circle
   * @param[in] duration Duration for effect to update number
   */
  void Update( unsigned int num, float radius, float duration = 0.f );

  /**
   * @brief Set Reverse order of numbers
   * @param reverse if the number is organised as revserse
   */
