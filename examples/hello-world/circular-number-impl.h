...
public:
   ...
   */
  static Dali::Toolkit::CircularNumber New( bool reverse );
...
public:
  ...
  /**
   * @copydoc Toolkit::CircularNumber::Update()
   */
  void Update( unsigned int num, float radius, float duration );

  /**
   * @copydoc Toolkit::CircularNumber::SetReverse()
   */
...
private:
  ...
  /**
   * @brief Create reverse effect
   *
   * @return newly created shader effect
   */
  ShaderEffect NewReverseEffect();
...
private:
  ...
  Timer         mTimer;
  bool          mReverse;                ///< indicates if numbers are arranged as reverse order

  ShaderEffect mReverseShaderEffect;
};
