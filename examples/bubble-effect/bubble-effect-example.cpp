...
private:
  ...
  void Create(Application& app)
  {
    ...
    mBubbleEmitter = Toolkit::BubbleEmitter::New( stageSize,
                                                  ...
                                                  DEFAULT_BUBBLE_SIZE);
    mBackgroundImage = DemoHelper::LoadImage( BACKGROUND_IMAGES[mCurrentBackgroundImageId], true );
 ...
 *****************/
  ...
  bool OnChangeIconClicked( Toolkit::Button button )
  {
    ...
    {
      mBackgroundImage = DemoHelper::LoadImage( BACKGROUND_IMAGES[ ++mCurrentBackgroundImageId % NUM_BACKGROUND_IMAGES  ], true );
