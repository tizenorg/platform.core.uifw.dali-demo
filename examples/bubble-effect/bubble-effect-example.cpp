 ...
 *****************/
  ...
  bool OnTouch(Dali::Actor actor, Dali::TouchData event)
  {
    switch( event.GetState( 0 ) )
    {
      case PointState::DOWN:
      {
        mCurrentTouchPosition = mEmitPosition = event.GetScreen( 0 );
      ...
      {
        Vector2 displacement = event.GetScreen( 0 ) - mCurrentTouchPosition;
        mCurrentTouchPosition = event.GetScreen( 0 );
