 ...
 */
void SetImageFittedInBox( ImageView& imageView, const char * const imagePath, int maxWidth, int maxHeight )
{
  Property::Map map;
  ...
  map["samsplingMode"] = "BOX_THEN_LINEAR";
...
public:
  ...
  void OnInit(Application& app)
  {
    ...
    SetImageFittedInBox( mMotionBlurImageView, MOTION_BLUR_ACTOR_IMAGE1, mMotionBlurActorSize.x, mMotionBlurActorSize.y );
  ...
  void ChangeImage()
  {
    ...
    SetImageFittedInBox( mMotionBlurImageView, MOTION_BLUR_ACTOR_IMAGES[mCurrentImage], mMotionBlurActorSize.x, mMotionBlurActorSize.y );
