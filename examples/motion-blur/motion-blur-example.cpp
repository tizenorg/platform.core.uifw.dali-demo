 ...
 */
ResourceImage LoadImage( const char * const imagePath, uint32_t maxWidth, uint32_t maxHeight )
{
...
public:
  ...
  void OnInit(Application& app)
  {
    ...
    Image image = LoadImage( MOTION_BLUR_ACTOR_IMAGE1, mMotionBlurActorSize.x, mMotionBlurActorSize.y );
  ...
  void ChangeImage()
  {
    ...
    Image blurImage = LoadImage( MOTION_BLUR_ACTOR_IMAGES[mCurrentImage], mMotionBlurActorSize.x, mMotionBlurActorSize.y );
