...
namespace
{
  ...
  const float OFFSET_BOTTOM = 0.9f;
...
public:
  ...
  void SetupModels( Layer layer )
  {
    ...
    //Top right model
    //mContainers[2].SetSizeModeFactor( Vector3( MODEL_SCALE / 3.0f, MODEL_SCALE / 3.0f, 0.0f ) );
    //mContainers[2].SetParentOrigin( Vector3( 0.95, 0.03, 0.5 ) ); //Offset from top right
    //mContainers[2].SetAnchorPoint( AnchorPoint::TOP_RIGHT );
  ...
  void SetupButtons( Layer layer )
  {
    ...
    changeTitleLabel.SetParentOrigin( Vector3( 0.2, OFFSET_BOTTOM, 0.5 ) );
    ...
    pauseButton.SetParentOrigin( Vector3( 0.5, OFFSET_BOTTOM, 0.5 ) );
    ...
    lightTitleLabel.SetParentOrigin( Vector3( 0.8, OFFSET_BOTTOM, 0.5 ) );
    ...
    lightButton.ClickedSignal().Connect( this, &MeshRendererController::OnChangeLightModeClicked );
  ...
  void SetupLight( Layer baseLayer )
  {
    ...
    mLightSource.SetSize( Vector2( 96.0f, 96.0f ) );
    ...
    lightMap.Insert( "rendererType", "IMAGE" );
    lightMap.Insert( "url", DEMO_IMAGE_DIR "light-icon.png" );
