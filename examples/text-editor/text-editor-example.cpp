...
public:
  ...
  void OnTextInputStyleChanged( TextEditor editor, TextEditor::InputStyleMask mask )
  {
    if( TextEditor::NONE != static_cast<TextEditor::InputStyleMask>( mask & TextEditor::INPUT_COLOR ) )
    {
