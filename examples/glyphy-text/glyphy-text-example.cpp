...
const char *ENGLISH_FONT_PATH = DALI_MODEL_DIR "DejaVuSans.ttf";
const char *CHINESE_FONT_PATH = DALI_MODEL_DIR "uming.ttc";
const char *KOREAN_FONT_PATH = DALI_MODEL_DIR "NanumGothic.ttf";
...
public:
  ...
  void Create( Application& application )
  {
    ...
    mStageBackground = CreateSolidColorActor(Vector4(1.f,1.f,1.f,0.01f));
