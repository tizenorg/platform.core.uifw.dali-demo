...
public:
  ...
  void Create( Application& application )
  {
    ...
    mOptionsButton = Toolkit::PushButton::New();
    mOptionsButton.SetName("OptionsButton");
    mOptionsButton.SetToggleButton( false );
    mOptionsButton.SetButtonImage( Dali::Image::New( PUSHBUTTON_BUTTON_IMAGE ) );
    ...
    mOptionsButton.SetLabelText( buttonLabel);
    mOptionsButton.SetSize( length*0.2f, length*0.05f );
    mOptionsButton.SetZ(1.f);
...
private:
  ...
  void CreateOptionPanel()
  {
    ...
    // Add a scale slider
    {
      ...
      sliderInfo.defaultValue = mScale;
