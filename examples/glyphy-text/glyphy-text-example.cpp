...
const Dali::PointSize         DEFAULT_TEXT_STYLE_POINT_SIZE( 10.f );
...
public:
  ...
  void Create( Application& application )
  {
   ...
   // FT_New_Face (ft_library, FONT_PATH, 0/*face_index*/, &ft_face);
    ...
    mPinchGestureDetector.Attach( background );
...
private:
  ...
  void OnPinch(Actor actor, PinchGesture gesture)
  {
    ...
    mScale = clamp(mScaleAtPinchStart * gesture.scale, 1.f, 10000.f);
