...
void CubeTransitionApp::OnInit( Application& application )
{
  ...
  mEffectChangeButton.SetButtonImage( EFFECT_WAVE_IMAGE );
  ...
  mSlideshowButton.SetButtonImage( SLIDE_SHOW_START_ICON );
...
bool CubeTransitionApp::OnEffectButtonClicked( Toolkit::Button button )
{
  if(mCurrentEffect == mCubeWaveEffect)
  {
    ...
    mEffectChangeButton.SetButtonImage( EFFECT_CROSS_IMAGE );
  ...
  else if(mCurrentEffect == mCubeCrossEffect)
  {
    ...
    mEffectChangeButton.SetButtonImage( EFFECT_FOLD_IMAGE );
...
bool CubeTransitionApp::OnSildeshowButtonClicked( Toolkit::Button button )
{
  ...
  if( mSlideshow )
  {
    ...
    mSlideshowButton.SetButtonImage( SLIDE_SHOW_STOP_ICON );
