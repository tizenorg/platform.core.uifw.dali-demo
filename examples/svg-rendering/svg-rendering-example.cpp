...
{
  //DALI_IMAGE_DIR "complex/rejon_Supergirl.svg",
  //DALI_IMAGE_DIR "basic/menu_example_.svg",
...
public:
  ...
  {
    // Load
    SvgAtlas* glyphyAtlas = new SvgAtlas( 1024,512, TEXTURE_ITEM_WIDTH, 8 );
    ...
    svgActor->SetSvgAtlas( glyphyAtlas->GetAtlasTexture() );
