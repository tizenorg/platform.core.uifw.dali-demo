#ifndef __DALI_SVG_ACTOR_H__
#define __DALI_SVG_ACTOR_H__
...
public:
  ...
  void SetVertices( const std::vector<Vertex>& vertexData );

  void SetSvgAtlas( Image glyphyAtlas );

  void SetGradientTexturePos( const Vector2& gradientTexPos );
...
private:
  ...
  Property::Index mIndexGradientTexturePos;
  Property::Index mIndexCenter;
};

#endif // __DALI_SVG_ACTOR_H__
