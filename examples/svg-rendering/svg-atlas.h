...
public:
  ...
  void AtlasAlloc( std::vector<unsigned char>&,
		           unsigned int *px,
		           unsigned int *py,
  ...
  Dali::Image GetAtlasTexture() { return mAtlasTexture; }
...
private:
  ...
  //std::vector<Dali::PixelDataPtr> mTextureItems;
 // Dali::Atlas mAtlasTexture;
};
