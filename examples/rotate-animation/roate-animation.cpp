...
public:
  ...
  void Create( Application& application )
  {
    ...
    Animation spinAnimation = Animation::New( 10.0f );
    AngleAxis bigSpin( Radian(Degree(900)), Vector3::ZAXIS );

    spinAnimation.AnimateBy( Property( wheel, Actor::Property::ORIENTATION ), bigSpin, AlphaFunction::EASE_OUT_BACK );
    spinAnimation.Play();
