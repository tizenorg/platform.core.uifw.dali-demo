...
{
  cout << "(time-logger)Begin FridgeApp-OnInitialize: " << getMS() << endl;

  cout << "(time-logger)Begin   init process: " << getMS() << endl;
  ...
  cout << "(time-logger)Begin   CreateBackground(): " << getMS() << endl;
  CreateBackground();
  cout << "(time-logger)Begin   CreatePosters(): " << getMS() << endl;
  CreatePosters();
  cout << "(time-logger)Begin   CreateTopPanel(): " << getMS() << endl;
  CreateTopPanel();
  cout << "(time-logger)Begin   CreateMenu(): " << getMS() << endl;
  CreateMenu();

  cout << "(time-logger)End__ FridgeApp-OnInitialize: " << getMS() << endl;
}
