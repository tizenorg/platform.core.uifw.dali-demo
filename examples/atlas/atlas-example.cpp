...
public:
  ...
  void Create( Application& application )
  {
    ...
    Atlas atlas1 = Atlas::New( 400,300, Pixel::RGBA8888);
    atlas1.Clear(Vector4(0.f,0.5f,0.5f,0.5f));
    atlas1.Upload( DALI_IMAGE_DIR "icon-change.png", 50, 30 );
    atlas1.Upload( DALI_IMAGE_DIR "icon-cluster-carousel.png", 100, 30 );
    atlas1.Upload( DALI_IMAGE_DIR "icon-effects-on.png", 150, 30 );
    atlas1.Upload( DALI_IMAGE_DIR "icon-effect-cross.png", 100, 80 );
    atlas1.Upload( DALI_IMAGE_DIR "icon-effect-fold.png", 150, 80 );
    atlas1.Upload( DALI_IMAGE_DIR "icon-effect-wave.png", 200, 80 );
    atlas1.Upload( DALI_IMAGE_DIR "icon-item-view-layout-depth.png", 150, 130 );
    atlas1.Upload( DALI_IMAGE_DIR "icon-item-view-layout-grid.png", 200, 130 );
    atlas1.Upload( DALI_IMAGE_DIR "icon-item-view-layout-spiral.png", 250, 130 );
    atlas1.Upload( CreateBufferImage( Vector4(1.f, 1.f, 1.f, 0.5f  ), 80, 90 ), 0, 210 );
    atlas1.Upload( CreateBufferImage( Vector4(1.f, 1.f, 0.75f, 0.5f  ), 80, 80 ), 40, 210 );
    atlas1.Upload( CreateBufferImage( Vector4(1.f, 1.f, 0.5f, 0.5f  ), 80, 70 ), 80, 210 );
    atlas1.Upload( CreateBufferImage( Vector4(1.f, 1.f, 0.25f, 0.5f  ), 80, 60 ), 120, 210 );
    atlas1.Upload( CreateBufferImage( Vector4(1.f, 1.f, 0.f, 0.5f  ), 80, 50 ), 160, 210 );
    atlas1.Upload( CreateBufferImage( Vector4(0.75f, 0.75f, 0.f, 0.5f  ), 80, 40 ), 200, 210 );
    atlas1.Upload( CreateBufferImage( Vector4(0.5f, 0.5f, 0.f, 0.5f  ), 80, 30 ), 240, 210 );
    atlas1.Upload( CreateBufferImage( Vector4(0.25f, 0.25f, 0.f, 0.5f  ), 80, 20 ), 280, 210 );
    atlas1.Upload( CreateBufferImage( Vector4(0.1f, 0.1f, 0.f, 0.5f  ), 80, 10 ), 320, 210 );
    BufferImage redBlock = CreateBufferImage( Color::RED, 40, 40 );
    atlas1.Upload(redBlock, 320, 30);
    atlas1.Upload(redBlock, 320, 80);
    atlas1.Upload(redBlock, 320, 130);
    ...
    ImageActor imageActor1 = ImageActor::New( atlas1 );
