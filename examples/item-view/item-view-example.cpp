...
public:
  ...
  void OnInit(Application& app)
  {
    ...
    editButton.SetButtonImage( EDIT_IMAGE );
    ...
    mLayoutButton.SetButtonImage( SPIRAL_LAYOUT_IMAGE );
    ...
    mDeleteButton.SetButtonImage( DELETE_IMAGE );
    ...
    mInsertButton.SetButtonImage( INSERT_IMAGE );
    ...
    mReplaceButton.SetButtonImage( REPLACE_IMAGE );
  ...
  void SetLayoutImage()
  {
    if( mLayoutButton )
    {
      switch( mCurrentLayout )
      {
        ...
        case GRID_LAYOUT:
        {
          mLayoutButton.SetButtonImage( GRID_LAYOUT_IMAGE );
        ...
        case DEPTH_LAYOUT:
        {
          mLayoutButton.SetButtonImage( DEPTH_LAYOUT_IMAGE );
