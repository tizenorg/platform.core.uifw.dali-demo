...
public: // From ItemFactory
  ...
  virtual Actor NewItem(unsigned int itemId)
  {
    ...
    Control borderActor = Control::New();
    ...
    borderProperty.Insert( "border-color", Color::WHITE );
    borderProperty.Insert( "border-size", ITEM_BORDER_SIZE );
    borderActor.SetProperty( Control::Property::BACKGROUND, borderProperty );
    ...
    Control checkbox = Control::New();
    checkbox.SetName( "CheckBox" );
    checkbox.SetBackgroundColor( Vector4( 0.6f, 0.6f, 0.6f, 1.0f ) );
