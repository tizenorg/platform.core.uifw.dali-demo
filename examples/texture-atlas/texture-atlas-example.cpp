...
public:
  ...
  void Create( Application& application )
  {
    ...
    mAtlasManager.SetAtlasSize( Vector2( 512, 512 ), Vector2( 256, 256 ) );
    AtlasManager::AtlasSlot slot1;
    AtlasManager::AtlasSlot slot2;

    mAtlasManager.Add( mImage, slot1 );
    mAtlasManager.Add( mImage2, slot2 );

    MeshData firstMesh;
    MeshData secondMesh;
    mAtlasManager.GenerateMeshData( slot1.mImage, Vector2( -140.0f, -160.0f ), firstMesh );
    mAtlasManager.GenerateMeshData( slot2.mImage, Vector2( -140.0f, -320.0f ), secondMesh );
