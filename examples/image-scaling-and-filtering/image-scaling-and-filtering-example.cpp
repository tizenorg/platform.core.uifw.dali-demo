...
const char* const STYLE_SMALL_TEXT = "builderlabel";
...
public:
  ...
  void CreateControls()
  {
...

    {
      ...
      label.SetProperty( Toolkit::Control::Property::STYLE_NAME, STYLE_SMALL_TEXT );
      fittingModeGroup.Add( label );

      Toolkit::PushButton button = CreateButton( FITTING_BUTTON_ID, StringFromScalingMode( mFittingMode ) );
      button.GetLabel().SetProperty( Toolkit::Control::Property::STYLE_NAME, STYLE_SMALL_TEXT );
  ...
  Toolkit::PushButton CreateButton( const char * id, const char * label )
  {
    ...
    button.SetProperty( Toolkit::Control::Property::STYLE_NAME, STYLE_SMALL_TEXT );
    button.SetName( id );
  ...
  bool CheckFittingModeButton( Actor &button, FittingMode::Type mode )
  {
    ...
    if( button.GetName() == modeName )
    {
      ...
      mFittingModeButton.GetLabel().SetProperty( Toolkit::Control::Property::STYLE_NAME, STYLE_SMALL_TEXT );
      ResizeImage();
      mPopup.Hide();
      mPopup.Reset();
      return true;
  ...
  bool CheckSamplingModeButton( Actor &button, SamplingMode::Type mode )
  {
    ...
    if( button.GetName() == modeName )
    {
      ...
      mSamplingModeButton.GetLabel().SetProperty( Toolkit::Control::Property::STYLE_NAME, STYLE_SMALL_TEXT );
      ResizeImage();
      mPopup.Hide();
      mPopup.Reset();
      return true;
