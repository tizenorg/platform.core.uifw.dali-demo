...
void StylingApplication::Create( Application& application )
{
  ...
  mContentPane = CreateResizableContentPane();
  ...
  contentLayout.SetResizePolicy( ResizePolicy::FIT_TO_CHILDREN, Dimension::HEIGHT );
  ...
  contentLayout.SetPosition( 0.0f, TOP_MARGIN );
  ...
  imageSelectLayout.SetResizePolicy( ResizePolicy::FIT_TO_CHILDREN, Dimension::HEIGHT );
  ...
  channelSliderLayout.SetResizePolicy( ResizePolicy::FIT_TO_CHILDREN, Dimension::HEIGHT );
  ...
  // channelSliderLayout.SetRowLayoutPolicy( /*row:*/ 0, FIT /*_HEIGHT*/ );
  // channelSliderLayout.SetColumnLayoutPolicy( /*col:*/ 0, FIT /*_WIDTH*/ );
  ...
  for( int i=0; i<3; ++i )
  {
    ...
    Property::Map map;
    map.Insert( "text", checkboxLabels[i] );
    mCheckButtons[i].SetProperty( Toolkit::Button::Property::LABEL, map );
