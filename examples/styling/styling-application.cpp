...
void StylingApplication::Create( Application& application )
{
  ...
  contentLayout.SetResizePolicy( ResizePolicy::USE_NATURAL_SIZE, Dimension::HEIGHT );
  ...
  // channelSliderLayout.SetRowLayoutPolicy( ROW_0, FIT /*_HEIGHT*/ );
  // channelSliderLayout.SetColumnLayoutPolicy( COLUMN_0, FIT /*_WIDTH*/ );
