...
const char* StylingApplication::DEMO_THEME_ONE_PATH( DEMO_STYLE_DIR "/style-example-one.json" );
const char* StylingApplication::DEMO_THEME_TWO_PATH( DEMO_STYLE_DIR "/style-example-two.json" );
const char* StylingApplication::DEMO_THEME_THREE_PATH( DEMO_STYLE_DIR "/style-example-three.json" );
...
void StylingApplication::Create( Application& application )
{
  ...
  mTitle.SetProperty( TextLabel::Property::TEXT_COLOR, Color::BLACK );
  Property::Map background;
  background.Insert("rendererType", "color");
  background.Insert("mixColor", Color::WHITE);
  mTitle.SetProperty( Control::Property::BACKGROUND, background );
  ...
  imageSelectLayout.SetBackgroundColor( BACKGROUND_COLOUR );
  ...
  for( int i=0; i<3; ++i )
  {
    ...
    Property::Map map;
    map.Insert( "textColor", Color::WHITE );
    mRadioButtons[i].SetProperty( Button::Property::LABEL, map );
  ...
  channelSliderLayout.SetBackgroundColor( BACKGROUND_COLOUR );
  ...
  for( int i=0; i<3; ++i )
  {
    ...
    std::ostringstream oss; oss << "colorLabel" << i;
    label.SetStyleName( oss.str() );
  ...
  label.SetProperty( TextLabel::Property::TEXT_COLOR, Color::CYAN );
...
Popup StylingApplication::CreateResetPopup()
{
  ...
  text.SetStyleName( "PopupContentText" );
  text.SetProperty( TextLabel::Property::TEXT_COLOR, Color::WHITE );
...
TextLabel StylingApplication::CreateTitle( std::string title )
{
  ...
  titleActor.SetProperty( TextLabel::Property::TEXT_COLOR, Color::WHITE );
