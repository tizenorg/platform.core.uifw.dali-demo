...
public:
  ...
  void Create( Application& application )
  {
    ...
    rootActor.SetResizePolicy( FIXED, ALL_DIMENSIONS );
    ...
    desktop.SetResizePolicy( FIXED, ALL_DIMENSIONS );
    ...
    photoBoxA.SetResizePolicy( FIXED, ALL_DIMENSIONS );
    ...
    field.SetResizePolicy( FILL_TO_PARENT, ALL_DIMENSIONS );
