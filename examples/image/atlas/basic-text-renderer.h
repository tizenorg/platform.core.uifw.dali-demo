...
private:
  ...
  Dali::BitmapImage CreateTestImage(const Dali::Vector4& color, bool border = false, const Dali::Vector4& borderColor = Dali::Color::WHITE, const unsigned int borderSize = 1 );
  void PackAtlas( const Dali::Vector<Dali::Toolkit::Text::GlyphInfo>& glyphs );
